...
class GlobalEventBusTest {
    ...
    @Test
    fun `Should successfully dispatch a single TestEvent`() = runTest {
    ...
    @Test
    fun `Should continue to dispatch events when dispatching to nonexistent event listeners`() = runTest {
