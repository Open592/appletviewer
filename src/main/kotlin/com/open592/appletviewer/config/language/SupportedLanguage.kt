...
public enum class SupportedLanguage {
    ...
    /**
     * Before loading remote content from the server we expose a small
     * number content for use in loading and error cases.
     */
    public fun getPackagedLocalizedContent(key: String): String {
        return PACKAGED_LOCALIZED_STRINGS[this]?.get(key) ?: ""
    }
